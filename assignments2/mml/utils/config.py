...
class ConfigS:
    ...
    text_model: str = "gpt2"    # "gpt2-medium"
    seed: int = 100
    num_workers: int = 2
    train_size: int = 0.84
    val_size: int = 0.13
...
class ConfigL:
    ...
    clip_model: str = "./models/clip-vit-large-patch14"
    text_model: str = "./models/gpt2-medium"
    seed: int = 100
    num_workers: int = 2    # 2
    train_size: int = 0.84
    val_size: int = 0.13
...
class ConfigQwen:
    ...
    clip_model: str = "./models/clip-vit-large-patch14"
    text_model: str = "./models/Qwen2.5-0.5B"
    seed: int = 100
    num_workers: int = 2    # 2
    train_size: int = 0.84
    val_size: int = 0.13
